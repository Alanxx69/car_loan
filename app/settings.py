...
SECRET_KEY = "django-insecure-2-8e8xa%4k9u##wic9ka5^&pp)2dubm^846)@6(@ecjd@hruvo"
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "app" / "templates"],  # Adicione esta linha
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
DATABASES = {
    "default": {
        ...
        "NAME": "car_loan",  # Nome do banco de dados
        "USER": "admin",  # Usuário do banco
        "PASSWORD": "admin",  # Senha do banco
        "HOST": "localhost",  # Nome do serviço do container ou localhost se estiver expondo a porta
        "PORT": "5433",  # Porta mapeada no Docker (altere se necessário)
    }
}
